...
#define Is_verbform(gs) ((stemtype_of(gs))&(VERBSTEM))
...
char * NameOfVoice();
char * NameOfDialect();
char * NameOfGeogRegions();
char * NameOfGender();
char * NameOfCase();
char * NameOfDegree();

FILE * MorphFopen();
Stemtype GetStemClass(), GetIsProse();
